...
// Room waiting state for sharing a fixed room and admitting the second participant.
    ...
    <main className="min-h-[100dvh] bg-meeting-canvas px-5 py-8 text-meeting-ink sm:px-8">
      <header className="mx-auto flex max-w-6xl items-center justify-between gap-4">
        ...
        <button
          type="button"
          onClick={onLeaveRoom}
          className="inline-flex min-h-10 items-center gap-2 whitespace-nowrap rounded-xl px-3 text-sm font-semibold text-meeting-muted transition hover:bg-white hover:text-meeting-ink focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-meeting-accent active:scale-[0.98]"
        >
      ...
      <section className="mx-auto mt-14 w-full max-w-3xl rounded-xl border border-meeting-line bg-white px-6 py-9 shadow-panel sm:px-10 sm:py-12">
        <div className="text-center">
          ...
          <h1 className="mt-3 text-3xl font-semibold text-meeting-ink sm:text-4xl">{roomName}</h1>
          <p className="mx-auto mt-4 max-w-md leading-7 text-meeting-muted">
            Share this room link with one participant. The room allows two people.
          </p>
        </div>
